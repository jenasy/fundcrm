...
> Deploy the SDK to the server, configure the four parameters specified in [install] (# install),
> and access the server address to operate the functions in [example] (# examples).
